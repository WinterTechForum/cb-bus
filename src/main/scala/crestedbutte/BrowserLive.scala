...
trait BrowserLive extends Browser {
  ...
  def browser: Browser.Service =
    new Browser.Service {
      ...
      override def alterUrlWithNewValue(
        url: String,
        paramName: String,
        paramValue: String,
      ): Unit =
      ...
      override def convertNodesToList(
